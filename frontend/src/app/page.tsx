...
export default function Home() {
  ...
  useEffect(() => {
    ...
    s.on("privateState", (state: { hand: Card[]; score: number }) => {
      ...
      <div className="flex flex-wrap justify-center gap-6 md:gap-12 mb-16">
        {gameState?.players
          ...
          .map((p, idx) => (
            ...
            >
              <div className="absolute -top-4 bg-slate-700 px-3 py-1 rounded-full text-xs font-bold text-slate-300">
                {p.biddingAction !== "pending" &&
                gameState?.status !== "waiting"
                  ? "Decided 🟢"
                  : "Thinking ⏳"}
              </div>
              <div className="mt-2 font-semibold text-amber-400 mb-4">
                {p.username}
              </div>
        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center md:items-end gap-6">
          ...
          <div className="flex-1 w-full relative">
            <div className="flex justify-between items-center mb-4">
              <div className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-amber-200 to-amber-500">
          ...
          {/* ACTION BUTTONS */}
          <div className="flex flex-col sm:flex-row md:flex-col gap-3 min-w-[280px] w-full md:w-auto shrink-0">
          ...
          >
            ...
            >
                ...
                {gameOverResult.players
                  ...
                  .map((p, idx) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center">
                        <div className="text-3xl font-mono font-bold text-white bg-slate-900 px-4 py-2 rounded-xl border border-slate-700 shadow-inner">
                          {p.score}{" "}
              ...
              <div className="mt-10 text-center">
                <button
                  onClick={handleReady}
                  className="bg-amber-600 hover:bg-amber-500 active:scale-95 text-slate-900 font-bold px-10 py-4 rounded-xl text-xl shadow-[0_0_20px_rgba(245,158,11,0.4)] transition-all"
                >
                  Chơi ván mới
                </button>
              </div>
